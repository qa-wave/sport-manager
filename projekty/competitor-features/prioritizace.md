...
- Nový kontrakt v `@club/contracts`: `ReadReceiptDto`.
...
- Nový `@club/contracts` schéma pro `FeeDto`, `PaymentDto` — greenfield.
...
STATUS: hotovo
VÝSTUP: /Users/tm/workspaces/projects/club-app/projekty/competitor-features/prioritizace.md
