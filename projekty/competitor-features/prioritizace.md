...
- Nový kontrakt v `@sport-manager/contracts`: `ReadReceiptDto`.
...
- Nový `@sport-manager/contracts` schéma pro `FeeDto`, `PaymentDto` — greenfield.
...
STATUS: hotovo
VÝSTUP: /Users/tm/workspaces/projects/sport-manager/projekty/competitor-features/prioritizace.md
