 ...
 *
 * Mirrors `@club/contracts` FeatureFlags — every key defined there MUST have
 ...
 * Next.js `apps/web` doesn't import from `@club/contracts` today; swap this
...
/** Matches `FEATURE_DEFAULTS` in `@club/contracts`. */
